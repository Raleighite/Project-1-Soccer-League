...
def open_csv(file_name):
    '''Opens the CSV file, transforms it's contents into a list of dictionary
...
def assigner(teams, players):
    '''Takes a list of available teams, and a list of dicts. Adds a
    Team attribute to each dict and ensures teams assigned are even'''
    count = 1
...
def generate_letters(players):
    '''Takes in a list of dicts and generates personalized letters
    for each player.'''
    for player in players:
...
Your child has been selected to participate in our Quidditch league! {Name}
will be playing on the {Team} team. The team's first practice will be on
{Practice}.
Please refer to our sport as 'Soccer' in public to avoid issues with muggles.
Thank you.
Yours sincerely,
    Travis
